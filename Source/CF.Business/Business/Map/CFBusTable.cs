...
namespace CF.Business.Business.Map
{
    public class CFBusTable
    {
        ...
        public CreateOrUpdateTableResponse CreateOrUpdateTable(CreateOrUpdateTableRequest input)
        {
            string methodName = MethodBase.GetCurrentMethod().Name;
            Log.Logger.Info(methodName, input);
            CreateOrUpdateTableResponse response = new CreateOrUpdateTableResponse();
            try
            {
                using (var _db = new CfDb())
                {
                    if (input.Table != null)
                    {
                        ...
                        if (zone != null)
                        {
                            if (!string.IsNullOrEmpty(input.Table.Name))
                            {
                                ...
                                if (string.IsNullOrEmpty(input.Table.ID))
                                {
